...
type Nav = NativeStackNavigationProp<DashboardStackParamList, 'Settings'>;
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, backgroundColor: bg }]}>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Header title="Settings" subtitle="Preferences and data" />
        ...
        <Card dark={dark} style={styles.card}>
          <Text style={[styles.label, { color: mutedColor }]}>Monthly income (for awareness)</Text>
          <TextInput
